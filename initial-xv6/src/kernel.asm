...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 7b 78 10 80 	movl   $0x8010787b,(%esp)
...
80101265:	e8 f6 31 00 00       	call   80104460 <memset>
  log_write(bp);
...
801012aa:	e8 a1 30 00 00       	call   80104350 <acquire>
...
8010130f:	e8 fc 30 00 00       	call   80104410 <release>
...
8010133a:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
8010133d:	e8 ce 30 00 00       	call   80104410 <release>
      return ip;
...
80101461:	e8 aa 30 00 00       	call   80104510 <memmove>
  brelse(bp);
...
80101496:	e8 75 2d 00 00       	call   80104210 <initlock>
...
801014af:	e8 2c 2c 00 00       	call   801040e0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010158e:	e8 cd 2e 00 00       	call   80104460 <memset>
      dip->type = type;
...
80101631:	e8 da 2e 00 00       	call   80104510 <memmove>
  log_write(bp);
...
8010166f:	e8 9c 2d 00 00       	call   80104410 <release>
}
...
801016a2:	e8 79 2a 00 00       	call   80104120 <acquiresleep>
  if(ip->valid == 0){
...
80101718:	e8 f3 2d 00 00       	call   80104510 <memmove>
    brelse(bp);
...
80101773:	e8 48 2a 00 00       	call   801041c0 <holdingsleep>
...
8010178e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010178f:	e9 ec 29 00 00       	jmp    80104180 <releasesleep>
    panic("iunlock");
...
801017c0:	e8 5b 29 00 00       	call   80104120 <acquiresleep>
...
801017da:	e8 a1 29 00 00       	call   80104180 <releasesleep>
  acquire(&icache.lock);
...
801017ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101800:	e9 0b 2c 00 00       	jmp    80104410 <release>
...
8010181f:	e8 ec 2b 00 00       	call   80104410 <release>
    if(r == 1){
...
80101a05:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a07:	e8 04 2b 00 00       	call   80104510 <memmove>
    brelse(bp);
...
80101b03:	e8 08 2a 00 00       	call   80104510 <memmove>
    log_write(bp);
...
80101b9e:	e8 dd 29 00 00       	call   80104580 <strncmp>
}
80101ba3:	c9                   	leave  
80101ba4:	c3                   	ret    
...
80101bfd:	e8 7e 29 00 00       	call   80104580 <strncmp>
      continue;
...
80101c99:	e8 72 27 00 00       	call   80104410 <release>
...
80101cf5:	e8 16 28 00 00       	call   80104510 <memmove>
    path++;
...
80101d88:	e8 83 27 00 00       	call   80104510 <memmove>
    name[len] = 0;
...
80101e7d:	e8 5e 27 00 00       	call   801045e0 <strncpy>
  de.inum = inum;
...
80101ec8:	68 62 76 10 80       	push   $0x80107662
...
80102010:	e8 fb 21 00 00       	call   80104210 <initlock>
...
8010210f:	e8 fc 22 00 00       	call   80104410 <release>
...
8010212e:	e8 8d 20 00 00       	call   801041c0 <holdingsleep>
...
801021d5:	c9                   	leave  
  release(&idelock);
801021d6:	e9 35 22 00 00       	jmp    80104410 <release>
801021db:	90                   	nop
...
80102342:	e8 19 21 00 00       	call   80104460 <memset>
...
8010237a:	c9                   	leave  
    release(&kmem.lock);
8010237b:	e9 90 20 00 00       	jmp    80104410 <release>
    acquire(&kmem.lock);
...
80102405:	e8 06 1e 00 00       	call   80104210 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102521:	e8 ea 1e 00 00       	call   80104410 <release>
  return (char*)r;
...
80102937:	e8 74 1b 00 00       	call   801044b0 <memcmp>
...
80102a64:	e8 a7 1a 00 00       	call   80104510 <memmove>
...
80102b14:	e8 f7 16 00 00       	call   80104210 <initlock>
  readsb(dev, &sb);
80102b19:	58                   	pop    %eax
...
80102bfc:	e8 0f 18 00 00       	call   80104410 <release>
      break;
    }
  }
}
...
80102c5c:	e8 af 17 00 00       	call   80104410 <release>
}
...
80102cb6:	e8 55 18 00 00       	call   80104510 <memmove>
...
80102d21:	e8 ea 16 00 00       	call   80104410 <release>
...
80102d4c:	e8 bf 16 00 00       	call   80104410 <release>
...
80102dfc:	c9                   	leave  
  release(&log.lock);
80102dfd:	e9 0e 16 00 00       	jmp    80104410 <release>
...
80102f14:	e8 f7 15 00 00       	call   80104510 <memmove>
...
80102ff4:	e8 b7 14 00 00       	call   801044b0 <memcmp>
...
801030b2:	e8 f9 13 00 00       	call   801044b0 <memcmp>
...
80103301:	e8 0a 0f 00 00       	call   80104210 <initlock>
  (*f0)->type = FD_PIPE;
...
801033a3:	5d                   	pop    %ebp
    release(&p->lock);
801033a4:	e9 67 10 00 00       	jmp    80104410 <release>
...
801033d4:	e8 37 10 00 00       	call   80104410 <release>
    kfree((char*)p);
...
80103494:	e8 77 0f 00 00       	call   80104410 <release>
        return -1;
...
801034eb:	e8 20 0f 00 00       	call   80104410 <release>
  return n;
...
8010357e:	e8 8d 0e 00 00       	call   80104410 <release>
      return -1;
...
801035df:	e8 2c 0e 00 00       	call   80104410 <release>
  return i;
...
8010364c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103652:	e8 b9 0d 00 00       	call   80104410 <release>
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 88 56 10 80 	movl   $0x80105688,0x14(%eax)
  p->context = (struct context*)sp;
...
80103686:	e8 d5 0d 00 00       	call   80104460 <memset>
...
801036aa:	e8 61 0d 00 00       	call   80104410 <release>
}
...
801036db:	e8 30 0d 00 00       	call   80104410 <release>
...
80103730:	e8 db 0a 00 00       	call   80104210 <initlock>
}
...
801037e4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037e7:	e8 94 0a 00 00       	call   80104280 <pushcli>
  c = mycpu();
801037ec:	e8 4f ff ff ff       	call   80103740 <mycpu>
  p = c->proc;
801037f1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037f7:	e8 c4 0a 00 00       	call   801042c0 <popcli>
}
...
80103856:	e8 05 0c 00 00       	call   80104460 <memset>
...
801038b5:	e8 86 0d 00 00       	call   80104640 <safestrcpy>
  p->cwd = namei("/");
...
801038e3:	e8 28 0b 00 00       	call   80104410 <release>
}
...
80103905:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103908:	e8 73 09 00 00       	call   80104280 <pushcli>
  c = mycpu();
8010390d:	e8 2e fe ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103912:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103918:	e8 a3 09 00 00       	call   801042c0 <popcli>
  if(n > 0){
...
80103986:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103989:	e8 f2 08 00 00       	call   80104280 <pushcli>
  c = mycpu();
8010398e:	e8 ad fd ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103993:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103999:	e8 22 09 00 00       	call   801042c0 <popcli>
  if((np = allocproc()) == 0){
...
80103ace:	e8 7d 08 00 00       	call   80104350 <acquire>
...
80103afb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b02:	e8 94 0b 00 00       	call   8010469b <swtch>
      switchkvm();
...
80103b2c:	e8 df 08 00 00       	call   80104410 <release>
    sti();
...
80103b44:	53                   	push   %ebx
  pushcli();
80103b45:	e8 36 07 00 00       	call   80104280 <pushcli>
  c = mycpu();
80103b4a:	e8 f1 fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103b4f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b55:	e8 66 07 00 00       	call   801042c0 <popcli>
  if(!holding(&ptable.lock))
80103b5a:	83 ec 0c             	sub    $0xc,%esp
80103b5d:	68 20 2d 11 80       	push   $0x80112d20
80103b62:	e8 b9 07 00 00       	call   80104320 <holding>
...
80103ba3:	e8 f3 0a 00 00       	call   8010469b <swtch>
  mycpu()->intena = intena;
...
80103c06:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c09:	e8 72 06 00 00       	call   80104280 <pushcli>
  c = mycpu();
80103c0e:	e8 2d fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103c13:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c19:	e8 a2 06 00 00       	call   801042c0 <popcli>
  if(curproc == initproc)
...
80103c72:	e8 d9 06 00 00       	call   80104350 <acquire>
...
80103d3c:	e8 0f 06 00 00       	call   80104350 <acquire>
  pushcli();
80103d41:	e8 3a 05 00 00       	call   80104280 <pushcli>
  c = mycpu();
80103d46:	e8 f5 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d4b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d51:	e8 6a 05 00 00       	call   801042c0 <popcli>
...
80103d69:	e8 a2 06 00 00       	call   80104410 <release>
}
...
80103d8c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103d8f:	e8 ec 04 00 00       	call   80104280 <pushcli>
  c = mycpu();
80103d94:	e8 a7 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d99:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d9f:	e8 1c 05 00 00       	call   801042c0 <popcli>
  if(p == 0)
...
80103dc0:	e8 8b 05 00 00       	call   80104350 <acquire>
    release(lk);
80103dc5:	89 34 24             	mov    %esi,(%esp)
80103dc8:	e8 43 06 00 00       	call   80104410 <release>
  p->chan = chan;
...
80103dea:	e8 21 06 00 00       	call   80104410 <release>
    acquire(lk);
...
80103dfb:	5d                   	pop    %ebp
    acquire(lk);
80103dfc:	e9 4f 05 00 00       	jmp    80104350 <acquire>
...
80103ea0:	74 7a                	je     80103f1c <wait+0xdc>
80103ea2:	8b 46 24             	mov    0x24(%esi),%eax
80103ea5:	85 c0                	test   %eax,%eax
80103ea7:	75 73                	jne    80103f1c <wait+0xdc>
...
80103ec0:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103ec3:	01 46 7c             	add    %eax,0x7c(%esi)
        kfree(p->kstack);
80103ec6:	83 ec 0c             	sub    $0xc,%esp
80103ec9:	ff 73 08             	pushl  0x8(%ebx)
        pid = p->pid;
80103ecc:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103ecf:	e8 3c e4 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
80103ed4:	5a                   	pop    %edx
80103ed5:	ff 73 04             	pushl  0x4(%ebx)
        p->kstack = 0;
80103ed8:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103edf:	e8 fc 2c 00 00       	call   80106be0 <freevm>
        release(&ptable.lock);
...
80103f04:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f0b:	e8 00 05 00 00       	call   80104410 <release>
        return pid;
80103f10:	83 c4 10             	add    $0x10,%esp
}
80103f13:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103f16:	89 f0                	mov    %esi,%eax
80103f18:	5b                   	pop    %ebx
80103f19:	5e                   	pop    %esi
80103f1a:	5d                   	pop    %ebp
80103f1b:	c3                   	ret    
...
80103f1c:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80103f1f:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f24:	68 20 2d 11 80       	push   $0x80112d20
80103f29:	e8 e2 04 00 00       	call   80104410 <release>
      return -1;
80103f2e:	83 c4 10             	add    $0x10,%esp
80103f31:	eb e0                	jmp    80103f13 <wait+0xd3>
...
8010403b:	68 7b 78 10 80       	push   $0x8010787b
...
80104145:	e8 36 fc ff ff       	call   80103d80 <sleep>
  while (lk->locked) {
...
80104153:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104159:	e8 82 f6 ff ff       	call   801037e0 <myproc>
...
801041e3:	e8 f8 f5 ff ff       	call   801037e0 <myproc>
...
80104289:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010428a:	e8 b1 f4 ff ff       	call   80103740 <mycpu>
...
8010429f:	e8 9c f4 ff ff       	call   80103740 <mycpu>
...
801042ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801042f0:	e8 4b f4 ff ff       	call   80103740 <mycpu>
...
80104305:	68 83 75 10 80       	push   $0x80107583
8010430a:	e8 81 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
8010430f:	83 ec 0c             	sub    $0xc,%esp
80104312:	68 9a 75 10 80       	push   $0x8010759a
...
80104338:	e8 03 f4 ff ff       	call   80103740 <mycpu>
...
80104394:	e8 a7 f3 ff ff       	call   80103740 <mycpu>
...
801043f7:	68 a1 75 10 80       	push   $0x801075a1
...
8010444c:	68 a9 75 10 80       	push   $0x801075a9
...
801046b7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801046ba:	e8 21 f1 ff ff       	call   801037e0 <myproc>
...
80104765:	e8 76 f0 ff ff       	call   801037e0 <myproc>
...
80104773:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104776:	e8 65 f0 ff ff       	call   801037e0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801047b8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801047bb:	e8 20 f0 ff ff       	call   801037e0 <myproc>
...
80104854:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
80104855:	e8 86 ef ff ff       	call   801037e0 <myproc>
8010485a:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
8010485c:	8b 40 18             	mov    0x18(%eax),%eax
8010485f:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104862:	8d 50 ff             	lea    -0x1(%eax),%edx
80104865:	83 fa 15             	cmp    $0x15,%edx
80104868:	77 26                	ja     80104890 <syscall+0x40>
8010486a:	8b 34 85 e0 75 10 80 	mov    -0x7fef8a20(,%eax,4),%esi
80104871:	85 f6                	test   %esi,%esi
80104873:	74 1b                	je     80104890 <syscall+0x40>
    if (num == SYS_read)
80104875:	83 f8 05             	cmp    $0x5,%eax
80104878:	74 46                	je     801048c0 <syscall+0x70>
      myproc()->readcount++;
    curproc->tf->eax = syscalls[num]();
8010487a:	ff d6                	call   *%esi
8010487c:	8b 53 18             	mov    0x18(%ebx),%edx
8010487f:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
80104898:	68 b1 75 10 80       	push   $0x801075b1
...
801048b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      myproc()->readcount++;
801048c0:	e8 1b ef ff ff       	call   801037e0 <myproc>
801048c5:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
801048c9:	eb af                	jmp    8010487a <syscall+0x2a>
...
801048e7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
801048ea:	e8 11 d6 ff ff       	call   80101f00 <nameiparent>
801048ef:	83 c4 10             	add    $0x10,%esp
801048f2:	85 c0                	test   %eax,%eax
801048f4:	0f 84 46 01 00 00    	je     80104a40 <create+0x170>
    return 0;
  ilock(dp);
801048fa:	83 ec 0c             	sub    $0xc,%esp
801048fd:	89 c3                	mov    %eax,%ebx
801048ff:	50                   	push   %eax
80104900:	e8 7b cd ff ff       	call   80101680 <ilock>
...
8010490c:	e8 9f d2 ff ff       	call   80101bb0 <dirlookup>
80104911:	83 c4 10             	add    $0x10,%esp
80104914:	85 c0                	test   %eax,%eax
80104916:	89 c7                	mov    %eax,%edi
80104918:	74 36                	je     80104950 <create+0x80>
    iunlockput(dp);
8010491a:	83 ec 0c             	sub    $0xc,%esp
8010491d:	53                   	push   %ebx
8010491e:	e8 ed cf ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80104923:	89 3c 24             	mov    %edi,(%esp)
80104926:	e8 55 cd ff ff       	call   80101680 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010492b:	83 c4 10             	add    $0x10,%esp
8010492e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104933:	0f 85 97 00 00 00    	jne    801049d0 <create+0x100>
80104939:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
8010493e:	0f 85 8c 00 00 00    	jne    801049d0 <create+0x100>
...
80104944:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104947:	89 f8                	mov    %edi,%eax
80104949:	5b                   	pop    %ebx
8010494a:	5e                   	pop    %esi
8010494b:	5f                   	pop    %edi
8010494c:	5d                   	pop    %ebp
...
80104958:	ff 33                	pushl  (%ebx)
8010495a:	e8 b1 cb ff ff       	call   80101510 <ialloc>
8010495f:	83 c4 10             	add    $0x10,%esp
80104962:	85 c0                	test   %eax,%eax
80104964:	89 c7                	mov    %eax,%edi
80104966:	0f 84 e8 00 00 00    	je     80104a54 <create+0x184>
  ilock(ip);
...
80104979:	66 89 47 52          	mov    %ax,0x52(%edi)
  ip->minor = minor;
8010497d:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80104981:	66 89 47 54          	mov    %ax,0x54(%edi)
  ip->nlink = 1;
80104985:	b8 01 00 00 00       	mov    $0x1,%eax
8010498a:	66 89 47 56          	mov    %ax,0x56(%edi)
  iupdate(ip);
8010498e:	89 3c 24             	mov    %edi,(%esp)
80104991:	e8 3a cc ff ff       	call   801015d0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104996:	83 c4 10             	add    $0x10,%esp
80104999:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
8010499e:	74 50                	je     801049f0 <create+0x120>
  if(dirlink(dp, name, ip->inum) < 0)
801049a0:	83 ec 04             	sub    $0x4,%esp
801049a3:	ff 77 04             	pushl  0x4(%edi)
801049a6:	56                   	push   %esi
801049a7:	53                   	push   %ebx
801049a8:	e8 73 d4 ff ff       	call   80101e20 <dirlink>
801049ad:	83 c4 10             	add    $0x10,%esp
801049b0:	85 c0                	test   %eax,%eax
801049b2:	0f 88 8f 00 00 00    	js     80104a47 <create+0x177>
  iunlockput(dp);
801049b8:	83 ec 0c             	sub    $0xc,%esp
801049bb:	53                   	push   %ebx
801049bc:	e8 4f cf ff ff       	call   80101910 <iunlockput>
  return ip;
...
801049e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    dp->nlink++;  // for ".."
801049f0:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
    iupdate(dp);
801049f5:	83 ec 0c             	sub    $0xc,%esp
801049f8:	53                   	push   %ebx
801049f9:	e8 d2 cb ff ff       	call   801015d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801049fe:	83 c4 0c             	add    $0xc,%esp
80104a01:	ff 77 04             	pushl  0x4(%edi)
80104a04:	68 58 76 10 80       	push   $0x80107658
...
80104a14:	78 1c                	js     80104a32 <create+0x162>
80104a16:	83 ec 04             	sub    $0x4,%esp
80104a19:	ff 73 04             	pushl  0x4(%ebx)
80104a1c:	68 57 76 10 80       	push   $0x80107657
80104a21:	57                   	push   %edi
80104a22:	e8 f9 d3 ff ff       	call   80101e20 <dirlink>
80104a27:	83 c4 10             	add    $0x10,%esp
80104a2a:	85 c0                	test   %eax,%eax
80104a2c:	0f 89 6e ff ff ff    	jns    801049a0 <create+0xd0>
      panic("create dots");
80104a32:	83 ec 0c             	sub    $0xc,%esp
80104a35:	68 4b 76 10 80       	push   $0x8010764b
80104a3a:	e8 51 b9 ff ff       	call   80100390 <panic>
80104a3f:	90                   	nop
    return 0;
80104a40:	31 ff                	xor    %edi,%edi
80104a42:	e9 fd fe ff ff       	jmp    80104944 <create+0x74>
    panic("create: dirlink");
80104a47:	83 ec 0c             	sub    $0xc,%esp
80104a4a:	68 5a 76 10 80       	push   $0x8010765a
80104a4f:	e8 3c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a54:	83 ec 0c             	sub    $0xc,%esp
80104a57:	68 3c 76 10 80       	push   $0x8010763c
80104a5c:	e8 2f b9 ff ff       	call   80100390 <panic>
80104a61:	eb 0d                	jmp    80104a70 <argfd.constprop.0>
80104a63:	90                   	nop
80104a64:	90                   	nop
80104a65:	90                   	nop
80104a66:	90                   	nop
...
80104abd:	eb ef                	jmp    80104aae <argfd.constprop.0+0x3e>
80104abf:	90                   	nop
...
80104aca:	83 ec 10             	sub    $0x10,%esp
  if(argfd(0, 0, &f) < 0)
80104acd:	e8 9e ff ff ff       	call   80104a70 <argfd.constprop.0>
80104ad2:	85 c0                	test   %eax,%eax
80104ad4:	78 42                	js     80104b18 <sys_dup+0x58>
  if((fd=fdalloc(f)) < 0)
80104ad6:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
80104ad9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104adb:	e8 00 ed ff ff       	call   801037e0 <myproc>
80104ae0:	eb 0e                	jmp    80104af0 <sys_dup+0x30>
80104ae2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(fd = 0; fd < NOFILE; fd++){
80104ae8:	83 c3 01             	add    $0x1,%ebx
80104aeb:	83 fb 10             	cmp    $0x10,%ebx
80104aee:	74 28                	je     80104b18 <sys_dup+0x58>
    if(curproc->ofile[fd] == 0){
80104af0:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80104af4:	85 d2                	test   %edx,%edx
80104af6:	75 f0                	jne    80104ae8 <sys_dup+0x28>
      curproc->ofile[fd] = f;
80104af8:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
80104afc:	83 ec 0c             	sub    $0xc,%esp
80104aff:	ff 75 f4             	pushl  -0xc(%ebp)
80104b02:	e8 e9 c2 ff ff       	call   80100df0 <filedup>
  return fd;
80104b07:	83 c4 10             	add    $0x10,%esp
}
80104b0a:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104b0d:	89 d8                	mov    %ebx,%eax
80104b0f:	5b                   	pop    %ebx
80104b10:	5e                   	pop    %esi
80104b11:	5d                   	pop    %ebp
80104b12:	c3                   	ret    
...
80104b18:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return -1;
...
80104b4d:	e8 0e fc ff ff       	call   80104760 <argint>
...
80104b65:	e8 46 fc ff ff       	call   801047b0 <argptr>
...
80104b7d:	e8 de c3 ff ff       	call   80100f60 <fileread>
...
80104bbd:	e8 9e fb ff ff       	call   80104760 <argint>
...
80104bd5:	e8 d6 fb ff ff       	call   801047b0 <argptr>
...
80104bed:	e8 fe c3 ff ff       	call   80100ff0 <filewrite>
...
80104c23:	78 2b                	js     80104c50 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104c25:	e8 b6 eb ff ff       	call   801037e0 <myproc>
...
80104c3b:	e8 00 c2 ff ff       	call   80100e40 <fileclose>
  return 0;
...
80104c7f:	e8 2c fb ff ff       	call   801047b0 <argptr>
...
80104c94:	e8 77 c2 ff ff       	call   80100f10 <filestat>
...
80104cbf:	e8 4c fb ff ff       	call   80104810 <argstr>
...
80104d28:	e8 a3 c8 ff ff       	call   801015d0 <iupdate>
  iunlock(ip);
80104d2d:	89 1c 24             	mov    %ebx,(%esp)
80104d30:	e8 2b ca ff ff       	call   80101760 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104d35:	58                   	pop    %eax
80104d36:	5a                   	pop    %edx
80104d37:	57                   	push   %edi
80104d38:	ff 75 d0             	pushl  -0x30(%ebp)
80104d3b:	e8 c0 d1 ff ff       	call   80101f00 <nameiparent>
...
80104d4d:	e8 2e c9 ff ff       	call   80101680 <ilock>
...
80104d63:	e8 b8 d0 ff ff       	call   80101e20 <dirlink>
...
80104d73:	e8 98 cb ff ff       	call   80101910 <iunlockput>
  iput(ip);
80104d78:	89 1c 24             	mov    %ebx,(%esp)
80104d7b:	e8 30 ca ff ff       	call   801017b0 <iput>
  end_op();
...
80104d9c:	e8 6f cb ff ff       	call   80101910 <iunlockput>
    goto bad;
80104da1:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80104da4:	83 ec 0c             	sub    $0xc,%esp
80104da7:	53                   	push   %ebx
80104da8:	e8 d3 c8 ff ff       	call   80101680 <ilock>
  ip->nlink--;
80104dad:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104db2:	89 1c 24             	mov    %ebx,(%esp)
80104db5:	e8 16 c8 ff ff       	call   801015d0 <iupdate>
  iunlockput(ip);
80104dba:	89 1c 24             	mov    %ebx,(%esp)
80104dbd:	e8 4e cb ff ff       	call   80101910 <iunlockput>
  end_op();
80104dc2:	e8 49 de ff ff       	call   80102c10 <end_op>
  return -1;
...
80104ddb:	e8 30 cb ff ff       	call   80101910 <iunlockput>
    end_op();
80104de0:	e8 2b de ff ff       	call   80102c10 <end_op>
    return -1;
80104de5:	83 c4 10             	add    $0x10,%esp
80104de8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104ded:	eb 9b                	jmp    80104d8a <sys_link+0xda>
    end_op();
80104def:	e8 1c de ff ff       	call   80102c10 <end_op>
    return -1;
80104df4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104df9:	eb 8f                	jmp    80104d8a <sys_link+0xda>
80104dfb:	90                   	nop
...
80104e19:	0f 88 77 01 00 00    	js     80104f96 <sys_unlink+0x196>
  if((dp = nameiparent(path, name)) == 0){
80104e1f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80104e22:	e8 79 dd ff ff       	call   80102ba0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104e3a:	0f 84 60 01 00 00    	je     80104fa0 <sys_unlink+0x1a0>
  ilock(dp);
80104e40:	83 ec 0c             	sub    $0xc,%esp
80104e43:	50                   	push   %eax
80104e44:	e8 37 c8 ff ff       	call   80101680 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104e49:	58                   	pop    %eax
80104e4a:	5a                   	pop    %edx
80104e4b:	68 58 76 10 80       	push   $0x80107658
80104e50:	53                   	push   %ebx
80104e51:	e8 3a cd ff ff       	call   80101b90 <namecmp>
80104e56:	83 c4 10             	add    $0x10,%esp
80104e59:	85 c0                	test   %eax,%eax
80104e5b:	0f 84 03 01 00 00    	je     80104f64 <sys_unlink+0x164>
80104e61:	83 ec 08             	sub    $0x8,%esp
80104e64:	68 57 76 10 80       	push   $0x80107657
80104e69:	53                   	push   %ebx
80104e6a:	e8 21 cd ff ff       	call   80101b90 <namecmp>
80104e6f:	83 c4 10             	add    $0x10,%esp
80104e72:	85 c0                	test   %eax,%eax
80104e74:	0f 84 ea 00 00 00    	je     80104f64 <sys_unlink+0x164>
...
80104e83:	e8 28 cd ff ff       	call   80101bb0 <dirlookup>
80104e88:	83 c4 10             	add    $0x10,%esp
80104e8b:	85 c0                	test   %eax,%eax
80104e8d:	89 c3                	mov    %eax,%ebx
80104e8f:	0f 84 cf 00 00 00    	je     80104f64 <sys_unlink+0x164>
  ilock(ip);
80104e95:	83 ec 0c             	sub    $0xc,%esp
80104e98:	50                   	push   %eax
80104e99:	e8 e2 c7 ff ff       	call   80101680 <ilock>
  if(ip->nlink < 1)
80104e9e:	83 c4 10             	add    $0x10,%esp
80104ea1:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104ea6:	0f 8e 10 01 00 00    	jle    80104fbc <sys_unlink+0x1bc>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104eac:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104eb1:	74 6d                	je     80104f20 <sys_unlink+0x120>
  memset(&de, 0, sizeof(de));
80104eb3:	8d 45 d8             	lea    -0x28(%ebp),%eax
80104eb6:	83 ec 04             	sub    $0x4,%esp
80104eb9:	6a 10                	push   $0x10
80104ebb:	6a 00                	push   $0x0
80104ebd:	50                   	push   %eax
80104ebe:	e8 9d f5 ff ff       	call   80104460 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104ec3:	8d 45 d8             	lea    -0x28(%ebp),%eax
80104ec6:	6a 10                	push   $0x10
80104ec8:	ff 75 c4             	pushl  -0x3c(%ebp)
80104ecb:	50                   	push   %eax
80104ecc:	56                   	push   %esi
80104ecd:	e8 8e cb ff ff       	call   80101a60 <writei>
80104ed2:	83 c4 20             	add    $0x20,%esp
80104ed5:	83 f8 10             	cmp    $0x10,%eax
80104ed8:	0f 85 eb 00 00 00    	jne    80104fc9 <sys_unlink+0x1c9>
  if(ip->type == T_DIR){
80104ede:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104ee3:	0f 84 97 00 00 00    	je     80104f80 <sys_unlink+0x180>
  iunlockput(dp);
80104ee9:	83 ec 0c             	sub    $0xc,%esp
80104eec:	56                   	push   %esi
80104eed:	e8 1e ca ff ff       	call   80101910 <iunlockput>
  ip->nlink--;
80104ef2:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104ef7:	89 1c 24             	mov    %ebx,(%esp)
80104efa:	e8 d1 c6 ff ff       	call   801015d0 <iupdate>
  iunlockput(ip);
80104eff:	89 1c 24             	mov    %ebx,(%esp)
80104f02:	e8 09 ca ff ff       	call   80101910 <iunlockput>
  end_op();
80104f07:	e8 04 dd ff ff       	call   80102c10 <end_op>
  return 0;
...
80104f24:	76 8d                	jbe    80104eb3 <sys_unlink+0xb3>
...
80104f36:	0f 83 77 ff ff ff    	jae    80104eb3 <sys_unlink+0xb3>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104f3c:	8d 45 d8             	lea    -0x28(%ebp),%eax
80104f3f:	6a 10                	push   $0x10
80104f41:	57                   	push   %edi
80104f42:	50                   	push   %eax
80104f43:	53                   	push   %ebx
80104f44:	e8 17 ca ff ff       	call   80101960 <readi>
80104f49:	83 c4 10             	add    $0x10,%esp
80104f4c:	83 f8 10             	cmp    $0x10,%eax
80104f4f:	75 5e                	jne    80104faf <sys_unlink+0x1af>
    if(de.inum != 0)
80104f51:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80104f56:	74 d8                	je     80104f30 <sys_unlink+0x130>
    iunlockput(ip);
...
80104f68:	e8 a3 c9 ff ff       	call   80101910 <iunlockput>
  end_op();
80104f6d:	e8 9e dc ff ff       	call   80102c10 <end_op>
  return -1;
80104f72:	83 c4 10             	add    $0x10,%esp
80104f75:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f7a:	eb 95                	jmp    80104f11 <sys_unlink+0x111>
80104f7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    dp->nlink--;
80104f80:	66 83 6e 56 01       	subw   $0x1,0x56(%esi)
    iupdate(dp);
80104f85:	83 ec 0c             	sub    $0xc,%esp
80104f88:	56                   	push   %esi
80104f89:	e8 42 c6 ff ff       	call   801015d0 <iupdate>
80104f8e:	83 c4 10             	add    $0x10,%esp
80104f91:	e9 53 ff ff ff       	jmp    80104ee9 <sys_unlink+0xe9>
    return -1;
80104f96:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f9b:	e9 71 ff ff ff       	jmp    80104f11 <sys_unlink+0x111>
    end_op();
80104fa0:	e8 6b dc ff ff       	call   80102c10 <end_op>
    return -1;
80104fa5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104faa:	e9 62 ff ff ff       	jmp    80104f11 <sys_unlink+0x111>
      panic("isdirempty: readi");
80104faf:	83 ec 0c             	sub    $0xc,%esp
80104fb2:	68 7c 76 10 80       	push   $0x8010767c
80104fb7:	e8 d4 b3 ff ff       	call   80100390 <panic>
    panic("unlink: nlink < 1");
80104fbc:	83 ec 0c             	sub    $0xc,%esp
80104fbf:	68 6a 76 10 80       	push   $0x8010766a
80104fc4:	e8 c7 b3 ff ff       	call   80100390 <panic>
    panic("unlink: writei");
80104fc9:	83 ec 0c             	sub    $0xc,%esp
80104fcc:	68 8e 76 10 80       	push   $0x8010768e
...
80105021:	0f 85 a9 00 00 00    	jne    801050d0 <sys_open+0xf0>
    if(ip == 0){
      end_op();
      return -1;
    }
...
8010502d:	e8 ae ce ff ff       	call   80101ee0 <namei>
80105032:	83 c4 10             	add    $0x10,%esp
80105035:	85 c0                	test   %eax,%eax
80105037:	89 c6                	mov    %eax,%esi
80105039:	0f 84 b2 00 00 00    	je     801050f1 <sys_open+0x111>
      end_op();
      return -1;
    }
    ilock(ip);
...
80105043:	e8 38 c6 ff ff       	call   80101680 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105048:	83 c4 10             	add    $0x10,%esp
8010504b:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105050:	0f 84 aa 00 00 00    	je     80105100 <sys_open+0x120>
      end_op();
      return -1;
    }
  }
...
80105056:	e8 25 bd ff ff       	call   80100d80 <filealloc>
8010505b:	85 c0                	test   %eax,%eax
8010505d:	89 c7                	mov    %eax,%edi
8010505f:	0f 84 a6 00 00 00    	je     8010510b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105065:	e8 76 e7 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010506a:	31 db                	xor    %ebx,%ebx
8010506c:	eb 0e                	jmp    8010507c <sys_open+0x9c>
8010506e:	66 90                	xchg   %ax,%ax
80105070:	83 c3 01             	add    $0x1,%ebx
80105073:	83 fb 10             	cmp    $0x10,%ebx
80105076:	0f 84 ac 00 00 00    	je     80105128 <sys_open+0x148>
    if(curproc->ofile[fd] == 0){
8010507c:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80105080:	85 d2                	test   %edx,%edx
80105082:	75 ec                	jne    80105070 <sys_open+0x90>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
80105084:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105087:	89 7c 98 28          	mov    %edi,0x28(%eax,%ebx,4)
  iunlock(ip);
8010508b:	56                   	push   %esi
8010508c:	e8 cf c6 ff ff       	call   80101760 <iunlock>
  end_op();
80105091:	e8 7a db ff ff       	call   80102c10 <end_op>

  f->type = FD_INODE;
80105096:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
8010509c:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010509f:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
801050a2:	89 77 10             	mov    %esi,0x10(%edi)
  f->off = 0;
801050a5:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
801050ac:	89 d0                	mov    %edx,%eax
801050ae:	f7 d0                	not    %eax
801050b0:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801050b3:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
801050b6:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801050b9:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
...
801050e9:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801050eb:	0f 85 65 ff ff ff    	jne    80105056 <sys_open+0x76>
      end_op();
801050f1:	e8 1a db ff ff       	call   80102c10 <end_op>
      return -1;
801050f6:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801050fb:	eb c0                	jmp    801050bd <sys_open+0xdd>
801050fd:	8d 76 00             	lea    0x0(%esi),%esi
    if(ip->type == T_DIR && omode != O_RDONLY){
80105100:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80105103:	85 c9                	test   %ecx,%ecx
80105105:	0f 84 4b ff ff ff    	je     80105056 <sys_open+0x76>
    iunlockput(ip);
8010510b:	83 ec 0c             	sub    $0xc,%esp
8010510e:	56                   	push   %esi
8010510f:	e8 fc c7 ff ff       	call   80101910 <iunlockput>
    end_op();
80105114:	e8 f7 da ff ff       	call   80102c10 <end_op>
    return -1;
80105119:	83 c4 10             	add    $0x10,%esp
8010511c:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105121:	eb 9a                	jmp    801050bd <sys_open+0xdd>
80105123:	90                   	nop
80105124:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      fileclose(f);
80105128:	83 ec 0c             	sub    $0xc,%esp
8010512b:	57                   	push   %edi
8010512c:	e8 0f bd ff ff       	call   80100e40 <fileclose>
80105131:	83 c4 10             	add    $0x10,%esp
80105134:	eb d5                	jmp    8010510b <sys_open+0x12b>
...
80105154:	e8 b7 f6 ff ff       	call   80104810 <argstr>
...
8010516f:	e8 5c f7 ff ff       	call   801048d0 <create>
...
801051a3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801051a6:	e8 f5 d9 ff ff       	call   80102ba0 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
801051c9:	e8 92 f5 ff ff       	call   80104760 <argint>
  if((argstr(0, &path)) < 0 ||
...
801051de:	e8 7d f5 ff ff       	call   80104760 <argint>
     argint(1, &major) < 0 ||
...
801051fe:	e8 cd f6 ff ff       	call   801048d0 <create>
...
8010520e:	e8 fd c6 ff ff       	call   80101910 <iunlockput>
  end_op();
80105213:	e8 f8 d9 ff ff       	call   80102c10 <end_op>
  return 0;
...
8010525f:	e8 7c cc ff ff       	call   80101ee0 <namei>
...
80105271:	e8 0a c4 ff ff       	call   80101680 <ilock>
  if(ip->type != T_DIR){
...
80105284:	e8 d7 c4 ff ff       	call   80101760 <iunlock>
  iput(curproc->cwd);
80105289:	58                   	pop    %eax
8010528a:	ff 76 68             	pushl  0x68(%esi)
8010528d:	e8 1e c5 ff ff       	call   801017b0 <iput>
  end_op();
80105292:	e8 79 d9 ff ff       	call   80102c10 <end_op>
  curproc->cwd = ip;
...
801052b4:	e8 57 c6 ff ff       	call   80101910 <iunlockput>
    end_op();
801052b9:	e8 52 d9 ff ff       	call   80102c10 <end_op>
    return -1;
...
8010531d:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
...
80105336:	e8 25 f1 ff ff       	call   80104460 <memset>
8010533b:	83 c4 10             	add    $0x10,%esp
8010533e:	eb 2c                	jmp    8010536c <sys_exec+0x8c>
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
      return -1;
    if(uarg == 0){
80105340:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
80105346:	85 c0                	test   %eax,%eax
80105348:	74 56                	je     801053a0 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
8010534a:	8d 8d 68 ff ff ff    	lea    -0x98(%ebp),%ecx
80105350:	83 ec 08             	sub    $0x8,%esp
80105353:	8d 14 31             	lea    (%ecx,%esi,1),%edx
80105356:	52                   	push   %edx
80105357:	50                   	push   %eax
80105358:	e8 93 f3 ff ff       	call   801046f0 <fetchstr>
8010535d:	83 c4 10             	add    $0x10,%esp
80105360:	85 c0                	test   %eax,%eax
80105362:	78 28                	js     8010538c <sys_exec+0xac>
  for(i=0;; i++){
80105364:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80105367:	83 fb 20             	cmp    $0x20,%ebx
8010536a:	74 20                	je     8010538c <sys_exec+0xac>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
8010536c:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105372:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
80105379:	83 ec 08             	sub    $0x8,%esp
8010537c:	57                   	push   %edi
8010537d:	01 f0                	add    %esi,%eax
8010537f:	50                   	push   %eax
80105380:	e8 2b f3 ff ff       	call   801046b0 <fetchint>
80105385:	83 c4 10             	add    $0x10,%esp
80105388:	85 c0                	test   %eax,%eax
8010538a:	79 b4                	jns    80105340 <sys_exec+0x60>
      return -1;
  }
...
801053bb:	e8 50 b6 ff ff       	call   80100a10 <exec>
...
801053eb:	0f 88 ae 00 00 00    	js     8010549f <sys_pipe+0xcf>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
801053f1:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801053f4:	83 ec 08             	sub    $0x8,%esp
801053f7:	50                   	push   %eax
801053f8:	8d 45 e0             	lea    -0x20(%ebp),%eax
801053fb:	50                   	push   %eax
801053fc:	e8 3f de ff ff       	call   80103240 <pipealloc>
80105401:	83 c4 10             	add    $0x10,%esp
80105404:	85 c0                	test   %eax,%eax
80105406:	0f 88 93 00 00 00    	js     8010549f <sys_pipe+0xcf>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010540c:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
8010540f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105411:	e8 ca e3 ff ff       	call   801037e0 <myproc>
80105416:	eb 10                	jmp    80105428 <sys_pipe+0x58>
80105418:	90                   	nop
80105419:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(fd = 0; fd < NOFILE; fd++){
80105420:	83 c3 01             	add    $0x1,%ebx
80105423:	83 fb 10             	cmp    $0x10,%ebx
80105426:	74 60                	je     80105488 <sys_pipe+0xb8>
    if(curproc->ofile[fd] == 0){
80105428:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
8010542c:	85 f6                	test   %esi,%esi
8010542e:	75 f0                	jne    80105420 <sys_pipe+0x50>
      curproc->ofile[fd] = f;
80105430:	8d 73 08             	lea    0x8(%ebx),%esi
80105433:	89 7c b0 08          	mov    %edi,0x8(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105437:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010543a:	e8 a1 e3 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010543f:	31 d2                	xor    %edx,%edx
80105441:	eb 0d                	jmp    80105450 <sys_pipe+0x80>
80105443:	90                   	nop
80105444:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105448:	83 c2 01             	add    $0x1,%edx
8010544b:	83 fa 10             	cmp    $0x10,%edx
8010544e:	74 28                	je     80105478 <sys_pipe+0xa8>
    if(curproc->ofile[fd] == 0){
80105450:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
80105454:	85 c9                	test   %ecx,%ecx
80105456:	75 f0                	jne    80105448 <sys_pipe+0x78>
      curproc->ofile[fd] = f;
80105458:	89 7c 90 28          	mov    %edi,0x28(%eax,%edx,4)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
8010545c:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010545f:	89 18                	mov    %ebx,(%eax)
  fd[1] = fd1;
80105461:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105464:	89 50 04             	mov    %edx,0x4(%eax)
  return 0;
...
80105471:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105478:	e8 63 e3 ff ff       	call   801037e0 <myproc>
8010547d:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
80105484:	00 
80105485:	8d 76 00             	lea    0x0(%esi),%esi
    fileclose(rf);
80105488:	83 ec 0c             	sub    $0xc,%esp
8010548b:	ff 75 e0             	pushl  -0x20(%ebp)
8010548e:	e8 ad b9 ff ff       	call   80100e40 <fileclose>
    fileclose(wf);
80105493:	58                   	pop    %eax
80105494:	ff 75 e4             	pushl  -0x1c(%ebp)
80105497:	e8 a4 b9 ff ff       	call   80100e40 <fileclose>
    return -1;
8010549c:	83 c4 10             	add    $0x10,%esp
8010549f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054a4:	eb c3                	jmp    80105469 <sys_pipe+0x99>
801054a6:	66 90                	xchg   %ax,%ax
801054a8:	66 90                	xchg   %ax,%ax
...
801054b3:	5d                   	pop    %ebp
  return fork();
801054b4:	e9 c7 e4 ff ff       	jmp    80103980 <fork>
...
801054c3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054c6:	e8 35 e7 ff ff       	call   80103c00 <exit>
...
801054d3:	5d                   	pop    %ebp
  return wait();
801054d4:	e9 67 e9 ff ff       	jmp    80103e40 <wait>
...
801054fe:	e8 9d ea ff ff       	call   80103fa0 <kill>
...
80105523:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105526:	e8 b5 e2 ff ff       	call   801037e0 <myproc>
...
80105547:	78 27                	js     80105570 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105549:	e8 92 e2 ff ff       	call   801037e0 <myproc>
  if(growproc(n) < 0)
...
80105556:	e8 a5 e3 ff ff       	call   80103900 <growproc>
...
801055a5:	e8 a6 ed ff ff       	call   80104350 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801055aa:	8b 55 f4             	mov    -0xc(%ebp),%edx
801055ad:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801055b0:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
...
801055c8:	68 a0 55 11 80       	push   $0x801155a0
801055cd:	e8 ae e7 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
801055d2:	a1 a0 55 11 80       	mov    0x801155a0,%eax
...
801055df:	73 2f                	jae    80105610 <sys_sleep+0x90>
    if(myproc()->killed){
801055e1:	e8 fa e1 ff ff       	call   801037e0 <myproc>
...
801055f5:	e8 16 ee ff ff       	call   80104410 <release>
      return -1;
...
80105618:	e8 f3 ed ff ff       	call   80104410 <release>
  return 0;
...
80105634:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105637:	68 60 4d 11 80       	push   $0x80114d60
8010563c:	e8 0f ed ff ff       	call   80104350 <acquire>
  xticks = ticks;
80105641:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
80105647:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
8010564e:	e8 bd ed ff ff       	call   80104410 <release>
  return xticks;
}
...
80105666:	e8 75 e1 ff ff       	call   801037e0 <myproc>
8010566b:	8b 40 7c             	mov    0x7c(%eax),%eax
}
8010566e:	c9                   	leave  
8010566f:	c3                   	ret    
...
80105671:	06                   	push   %es
  pushl %fs
80105672:	0f a0                	push   %fs
  pushl %gs
80105674:	0f a8                	push   %gs
  pushal
80105676:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105677:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010567b:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010567d:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010567f:	54                   	push   %esp
  call trap
80105680:	e8 cb 00 00 00       	call   80105750 <trap>
  addl $4, %esp
...
80105688:	61                   	popa   
  popl %gs
80105689:	0f a9                	pop    %gs
  popl %fs
8010568b:	0f a1                	pop    %fs
  popl %es
8010568d:	07                   	pop    %es
  popl %ds
8010568e:	1f                   	pop    %ds
...
801056b7:	c7 04 c5 a2 4d 11 80 	movl   $0x8e000008,-0x7feeb25e(,%eax,8)
801056be:	08 00 00 8e 
801056c2:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
801056c9:	80 
801056ca:	c1 ea 10             	shr    $0x10,%edx
801056cd:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
801056d4:	80 
  for(i = 0; i < 256; i++)
...
801056e4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056e7:	c7 05 a2 4f 11 80 08 	movl   $0xef000008,0x80114fa2
801056ee:	00 00 ef 
  initlock(&tickslock, "time");
801056f1:	68 9d 76 10 80       	push   $0x8010769d
801056f6:	68 60 4d 11 80       	push   $0x80114d60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056fb:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
80105701:	c1 e8 10             	shr    $0x10,%eax
80105704:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010570a:	e8 01 eb ff ff       	call   80104210 <initlock>
}
...
8010572b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010572f:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
80105770:	ff 24 85 44 77 10 80 	jmp    *-0x7fef88bc(,%eax,4)
...
801057d5:	68 00 77 10 80       	push   $0x80107700
...
80105917:	68 a8 76 10 80       	push   $0x801076a8
...
80105978:	e8 d3 e9 ff ff       	call   80104350 <acquire>
      wakeup(&ticks);
...
801059b5:	68 cc 76 10 80       	push   $0x801076cc
801059ba:	e8 a1 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
801059bf:	83 c4 14             	add    $0x14,%esp
801059c2:	68 a2 76 10 80       	push   $0x801076a2
...
80105abc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105abf:	bb c4 77 10 80       	mov    $0x801077c4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105b57:	6a 00                	push   $0x0
  jmp alltraps
80105b59:	e9 12 fb ff ff       	jmp    80105670 <alltraps>
...
80105b60:	6a 01                	push   $0x1
  jmp alltraps
80105b62:	e9 09 fb ff ff       	jmp    80105670 <alltraps>
...
80105b69:	6a 02                	push   $0x2
  jmp alltraps
80105b6b:	e9 00 fb ff ff       	jmp    80105670 <alltraps>
...
80105b72:	6a 03                	push   $0x3
  jmp alltraps
80105b74:	e9 f7 fa ff ff       	jmp    80105670 <alltraps>
...
80105b7b:	6a 04                	push   $0x4
  jmp alltraps
80105b7d:	e9 ee fa ff ff       	jmp    80105670 <alltraps>
...
80105b84:	6a 05                	push   $0x5
  jmp alltraps
80105b86:	e9 e5 fa ff ff       	jmp    80105670 <alltraps>
...
80105b8d:	6a 06                	push   $0x6
  jmp alltraps
80105b8f:	e9 dc fa ff ff       	jmp    80105670 <alltraps>
...
80105b96:	6a 07                	push   $0x7
  jmp alltraps
80105b98:	e9 d3 fa ff ff       	jmp    80105670 <alltraps>
...
80105b9d:	6a 08                	push   $0x8
  jmp alltraps
80105b9f:	e9 cc fa ff ff       	jmp    80105670 <alltraps>
...
80105ba6:	6a 09                	push   $0x9
  jmp alltraps
80105ba8:	e9 c3 fa ff ff       	jmp    80105670 <alltraps>
...
80105bad:	6a 0a                	push   $0xa
  jmp alltraps
80105baf:	e9 bc fa ff ff       	jmp    80105670 <alltraps>
...
80105bb4:	6a 0b                	push   $0xb
  jmp alltraps
80105bb6:	e9 b5 fa ff ff       	jmp    80105670 <alltraps>
...
80105bbb:	6a 0c                	push   $0xc
  jmp alltraps
80105bbd:	e9 ae fa ff ff       	jmp    80105670 <alltraps>
...
80105bc2:	6a 0d                	push   $0xd
  jmp alltraps
80105bc4:	e9 a7 fa ff ff       	jmp    80105670 <alltraps>
...
80105bc9:	6a 0e                	push   $0xe
  jmp alltraps
80105bcb:	e9 a0 fa ff ff       	jmp    80105670 <alltraps>
...
80105bd2:	6a 0f                	push   $0xf
  jmp alltraps
80105bd4:	e9 97 fa ff ff       	jmp    80105670 <alltraps>
...
80105bdb:	6a 10                	push   $0x10
  jmp alltraps
80105bdd:	e9 8e fa ff ff       	jmp    80105670 <alltraps>
...
80105be2:	6a 11                	push   $0x11
  jmp alltraps
80105be4:	e9 87 fa ff ff       	jmp    80105670 <alltraps>
...
80105beb:	6a 12                	push   $0x12
  jmp alltraps
80105bed:	e9 7e fa ff ff       	jmp    80105670 <alltraps>
...
80105bf4:	6a 13                	push   $0x13
  jmp alltraps
80105bf6:	e9 75 fa ff ff       	jmp    80105670 <alltraps>
...
80105bfd:	6a 14                	push   $0x14
  jmp alltraps
80105bff:	e9 6c fa ff ff       	jmp    80105670 <alltraps>
...
80105c06:	6a 15                	push   $0x15
  jmp alltraps
80105c08:	e9 63 fa ff ff       	jmp    80105670 <alltraps>
...
80105c0f:	6a 16                	push   $0x16
  jmp alltraps
80105c11:	e9 5a fa ff ff       	jmp    80105670 <alltraps>
...
80105c18:	6a 17                	push   $0x17
  jmp alltraps
80105c1a:	e9 51 fa ff ff       	jmp    80105670 <alltraps>
...
80105c21:	6a 18                	push   $0x18
  jmp alltraps
80105c23:	e9 48 fa ff ff       	jmp    80105670 <alltraps>
...
80105c2a:	6a 19                	push   $0x19
  jmp alltraps
80105c2c:	e9 3f fa ff ff       	jmp    80105670 <alltraps>
...
80105c33:	6a 1a                	push   $0x1a
  jmp alltraps
80105c35:	e9 36 fa ff ff       	jmp    80105670 <alltraps>
...
80105c3c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c3e:	e9 2d fa ff ff       	jmp    80105670 <alltraps>
...
80105c45:	6a 1c                	push   $0x1c
  jmp alltraps
80105c47:	e9 24 fa ff ff       	jmp    80105670 <alltraps>
...
80105c4e:	6a 1d                	push   $0x1d
  jmp alltraps
80105c50:	e9 1b fa ff ff       	jmp    80105670 <alltraps>
...
80105c57:	6a 1e                	push   $0x1e
  jmp alltraps
80105c59:	e9 12 fa ff ff       	jmp    80105670 <alltraps>
...
80105c60:	6a 1f                	push   $0x1f
  jmp alltraps
80105c62:	e9 09 fa ff ff       	jmp    80105670 <alltraps>
...
80105c69:	6a 20                	push   $0x20
  jmp alltraps
80105c6b:	e9 00 fa ff ff       	jmp    80105670 <alltraps>
...
80105c72:	6a 21                	push   $0x21
  jmp alltraps
80105c74:	e9 f7 f9 ff ff       	jmp    80105670 <alltraps>
...
80105c7b:	6a 22                	push   $0x22
  jmp alltraps
80105c7d:	e9 ee f9 ff ff       	jmp    80105670 <alltraps>
...
80105c84:	6a 23                	push   $0x23
  jmp alltraps
80105c86:	e9 e5 f9 ff ff       	jmp    80105670 <alltraps>
...
80105c8d:	6a 24                	push   $0x24
  jmp alltraps
80105c8f:	e9 dc f9 ff ff       	jmp    80105670 <alltraps>
...
80105c96:	6a 25                	push   $0x25
  jmp alltraps
80105c98:	e9 d3 f9 ff ff       	jmp    80105670 <alltraps>
...
80105c9f:	6a 26                	push   $0x26
  jmp alltraps
80105ca1:	e9 ca f9 ff ff       	jmp    80105670 <alltraps>
...
80105ca8:	6a 27                	push   $0x27
  jmp alltraps
80105caa:	e9 c1 f9 ff ff       	jmp    80105670 <alltraps>
...
80105cb1:	6a 28                	push   $0x28
  jmp alltraps
80105cb3:	e9 b8 f9 ff ff       	jmp    80105670 <alltraps>
...
80105cba:	6a 29                	push   $0x29
  jmp alltraps
80105cbc:	e9 af f9 ff ff       	jmp    80105670 <alltraps>
...
80105cc3:	6a 2a                	push   $0x2a
  jmp alltraps
80105cc5:	e9 a6 f9 ff ff       	jmp    80105670 <alltraps>
...
80105ccc:	6a 2b                	push   $0x2b
  jmp alltraps
80105cce:	e9 9d f9 ff ff       	jmp    80105670 <alltraps>
...
80105cd5:	6a 2c                	push   $0x2c
  jmp alltraps
80105cd7:	e9 94 f9 ff ff       	jmp    80105670 <alltraps>
...
80105cde:	6a 2d                	push   $0x2d
  jmp alltraps
80105ce0:	e9 8b f9 ff ff       	jmp    80105670 <alltraps>
...
80105ce7:	6a 2e                	push   $0x2e
  jmp alltraps
80105ce9:	e9 82 f9 ff ff       	jmp    80105670 <alltraps>
...
80105cf0:	6a 2f                	push   $0x2f
  jmp alltraps
80105cf2:	e9 79 f9 ff ff       	jmp    80105670 <alltraps>
...
80105cf9:	6a 30                	push   $0x30
  jmp alltraps
80105cfb:	e9 70 f9 ff ff       	jmp    80105670 <alltraps>
...
80105d02:	6a 31                	push   $0x31
  jmp alltraps
80105d04:	e9 67 f9 ff ff       	jmp    80105670 <alltraps>
...
80105d0b:	6a 32                	push   $0x32
  jmp alltraps
80105d0d:	e9 5e f9 ff ff       	jmp    80105670 <alltraps>
...
80105d14:	6a 33                	push   $0x33
  jmp alltraps
80105d16:	e9 55 f9 ff ff       	jmp    80105670 <alltraps>
...
80105d1d:	6a 34                	push   $0x34
  jmp alltraps
80105d1f:	e9 4c f9 ff ff       	jmp    80105670 <alltraps>
...
80105d26:	6a 35                	push   $0x35
  jmp alltraps
80105d28:	e9 43 f9 ff ff       	jmp    80105670 <alltraps>
...
80105d2f:	6a 36                	push   $0x36
  jmp alltraps
80105d31:	e9 3a f9 ff ff       	jmp    80105670 <alltraps>
...
80105d38:	6a 37                	push   $0x37
  jmp alltraps
80105d3a:	e9 31 f9 ff ff       	jmp    80105670 <alltraps>
...
80105d41:	6a 38                	push   $0x38
  jmp alltraps
80105d43:	e9 28 f9 ff ff       	jmp    80105670 <alltraps>
...
80105d4a:	6a 39                	push   $0x39
  jmp alltraps
80105d4c:	e9 1f f9 ff ff       	jmp    80105670 <alltraps>
...
80105d53:	6a 3a                	push   $0x3a
  jmp alltraps
80105d55:	e9 16 f9 ff ff       	jmp    80105670 <alltraps>
...
80105d5c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d5e:	e9 0d f9 ff ff       	jmp    80105670 <alltraps>
...
80105d65:	6a 3c                	push   $0x3c
  jmp alltraps
80105d67:	e9 04 f9 ff ff       	jmp    80105670 <alltraps>
...
80105d6e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d70:	e9 fb f8 ff ff       	jmp    80105670 <alltraps>
...
80105d77:	6a 3e                	push   $0x3e
  jmp alltraps
80105d79:	e9 f2 f8 ff ff       	jmp    80105670 <alltraps>
...
80105d80:	6a 3f                	push   $0x3f
  jmp alltraps
80105d82:	e9 e9 f8 ff ff       	jmp    80105670 <alltraps>
...
80105d89:	6a 40                	push   $0x40
  jmp alltraps
80105d8b:	e9 e0 f8 ff ff       	jmp    80105670 <alltraps>
...
80105d92:	6a 41                	push   $0x41
  jmp alltraps
80105d94:	e9 d7 f8 ff ff       	jmp    80105670 <alltraps>
...
80105d9b:	6a 42                	push   $0x42
  jmp alltraps
80105d9d:	e9 ce f8 ff ff       	jmp    80105670 <alltraps>
...
80105da4:	6a 43                	push   $0x43
  jmp alltraps
80105da6:	e9 c5 f8 ff ff       	jmp    80105670 <alltraps>
...
80105dad:	6a 44                	push   $0x44
  jmp alltraps
80105daf:	e9 bc f8 ff ff       	jmp    80105670 <alltraps>
...
80105db6:	6a 45                	push   $0x45
  jmp alltraps
80105db8:	e9 b3 f8 ff ff       	jmp    80105670 <alltraps>
...
80105dbf:	6a 46                	push   $0x46
  jmp alltraps
80105dc1:	e9 aa f8 ff ff       	jmp    80105670 <alltraps>
...
80105dc8:	6a 47                	push   $0x47
  jmp alltraps
80105dca:	e9 a1 f8 ff ff       	jmp    80105670 <alltraps>
...
80105dd1:	6a 48                	push   $0x48
  jmp alltraps
80105dd3:	e9 98 f8 ff ff       	jmp    80105670 <alltraps>
...
80105dda:	6a 49                	push   $0x49
  jmp alltraps
80105ddc:	e9 8f f8 ff ff       	jmp    80105670 <alltraps>
...
80105de3:	6a 4a                	push   $0x4a
  jmp alltraps
80105de5:	e9 86 f8 ff ff       	jmp    80105670 <alltraps>
...
80105dec:	6a 4b                	push   $0x4b
  jmp alltraps
80105dee:	e9 7d f8 ff ff       	jmp    80105670 <alltraps>
...
80105df5:	6a 4c                	push   $0x4c
  jmp alltraps
80105df7:	e9 74 f8 ff ff       	jmp    80105670 <alltraps>
...
80105dfe:	6a 4d                	push   $0x4d
  jmp alltraps
80105e00:	e9 6b f8 ff ff       	jmp    80105670 <alltraps>
...
80105e07:	6a 4e                	push   $0x4e
  jmp alltraps
80105e09:	e9 62 f8 ff ff       	jmp    80105670 <alltraps>
...
80105e10:	6a 4f                	push   $0x4f
  jmp alltraps
80105e12:	e9 59 f8 ff ff       	jmp    80105670 <alltraps>
...
80105e19:	6a 50                	push   $0x50
  jmp alltraps
80105e1b:	e9 50 f8 ff ff       	jmp    80105670 <alltraps>
...
80105e22:	6a 51                	push   $0x51
  jmp alltraps
80105e24:	e9 47 f8 ff ff       	jmp    80105670 <alltraps>
...
80105e2b:	6a 52                	push   $0x52
  jmp alltraps
80105e2d:	e9 3e f8 ff ff       	jmp    80105670 <alltraps>
...
80105e34:	6a 53                	push   $0x53
  jmp alltraps
80105e36:	e9 35 f8 ff ff       	jmp    80105670 <alltraps>
...
80105e3d:	6a 54                	push   $0x54
  jmp alltraps
80105e3f:	e9 2c f8 ff ff       	jmp    80105670 <alltraps>
...
80105e46:	6a 55                	push   $0x55
  jmp alltraps
80105e48:	e9 23 f8 ff ff       	jmp    80105670 <alltraps>
...
80105e4f:	6a 56                	push   $0x56
  jmp alltraps
80105e51:	e9 1a f8 ff ff       	jmp    80105670 <alltraps>
...
80105e58:	6a 57                	push   $0x57
  jmp alltraps
80105e5a:	e9 11 f8 ff ff       	jmp    80105670 <alltraps>
...
80105e61:	6a 58                	push   $0x58
  jmp alltraps
80105e63:	e9 08 f8 ff ff       	jmp    80105670 <alltraps>
...
80105e6a:	6a 59                	push   $0x59
  jmp alltraps
80105e6c:	e9 ff f7 ff ff       	jmp    80105670 <alltraps>
...
80105e73:	6a 5a                	push   $0x5a
  jmp alltraps
80105e75:	e9 f6 f7 ff ff       	jmp    80105670 <alltraps>
...
80105e7c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e7e:	e9 ed f7 ff ff       	jmp    80105670 <alltraps>
...
80105e85:	6a 5c                	push   $0x5c
  jmp alltraps
80105e87:	e9 e4 f7 ff ff       	jmp    80105670 <alltraps>
...
80105e8e:	6a 5d                	push   $0x5d
  jmp alltraps
80105e90:	e9 db f7 ff ff       	jmp    80105670 <alltraps>
...
80105e97:	6a 5e                	push   $0x5e
  jmp alltraps
80105e99:	e9 d2 f7 ff ff       	jmp    80105670 <alltraps>
...
80105ea0:	6a 5f                	push   $0x5f
  jmp alltraps
80105ea2:	e9 c9 f7 ff ff       	jmp    80105670 <alltraps>
...
80105ea9:	6a 60                	push   $0x60
  jmp alltraps
80105eab:	e9 c0 f7 ff ff       	jmp    80105670 <alltraps>
...
80105eb2:	6a 61                	push   $0x61
  jmp alltraps
80105eb4:	e9 b7 f7 ff ff       	jmp    80105670 <alltraps>
...
80105ebb:	6a 62                	push   $0x62
  jmp alltraps
80105ebd:	e9 ae f7 ff ff       	jmp    80105670 <alltraps>
...
80105ec4:	6a 63                	push   $0x63
  jmp alltraps
80105ec6:	e9 a5 f7 ff ff       	jmp    80105670 <alltraps>
...
80105ecd:	6a 64                	push   $0x64
  jmp alltraps
80105ecf:	e9 9c f7 ff ff       	jmp    80105670 <alltraps>
...
80105ed6:	6a 65                	push   $0x65
  jmp alltraps
80105ed8:	e9 93 f7 ff ff       	jmp    80105670 <alltraps>
...
80105edf:	6a 66                	push   $0x66
  jmp alltraps
80105ee1:	e9 8a f7 ff ff       	jmp    80105670 <alltraps>
...
80105ee8:	6a 67                	push   $0x67
  jmp alltraps
80105eea:	e9 81 f7 ff ff       	jmp    80105670 <alltraps>
...
80105ef1:	6a 68                	push   $0x68
  jmp alltraps
80105ef3:	e9 78 f7 ff ff       	jmp    80105670 <alltraps>
...
80105efa:	6a 69                	push   $0x69
  jmp alltraps
80105efc:	e9 6f f7 ff ff       	jmp    80105670 <alltraps>
...
80105f03:	6a 6a                	push   $0x6a
  jmp alltraps
80105f05:	e9 66 f7 ff ff       	jmp    80105670 <alltraps>
...
80105f0c:	6a 6b                	push   $0x6b
  jmp alltraps
80105f0e:	e9 5d f7 ff ff       	jmp    80105670 <alltraps>
...
80105f15:	6a 6c                	push   $0x6c
  jmp alltraps
80105f17:	e9 54 f7 ff ff       	jmp    80105670 <alltraps>
...
80105f1e:	6a 6d                	push   $0x6d
  jmp alltraps
80105f20:	e9 4b f7 ff ff       	jmp    80105670 <alltraps>
...
80105f27:	6a 6e                	push   $0x6e
  jmp alltraps
80105f29:	e9 42 f7 ff ff       	jmp    80105670 <alltraps>
...
80105f30:	6a 6f                	push   $0x6f
  jmp alltraps
80105f32:	e9 39 f7 ff ff       	jmp    80105670 <alltraps>
...
80105f39:	6a 70                	push   $0x70
  jmp alltraps
80105f3b:	e9 30 f7 ff ff       	jmp    80105670 <alltraps>
...
80105f42:	6a 71                	push   $0x71
  jmp alltraps
80105f44:	e9 27 f7 ff ff       	jmp    80105670 <alltraps>
...
80105f4b:	6a 72                	push   $0x72
  jmp alltraps
80105f4d:	e9 1e f7 ff ff       	jmp    80105670 <alltraps>
...
80105f54:	6a 73                	push   $0x73
  jmp alltraps
80105f56:	e9 15 f7 ff ff       	jmp    80105670 <alltraps>
...
80105f5d:	6a 74                	push   $0x74
  jmp alltraps
80105f5f:	e9 0c f7 ff ff       	jmp    80105670 <alltraps>
...
80105f66:	6a 75                	push   $0x75
  jmp alltraps
80105f68:	e9 03 f7 ff ff       	jmp    80105670 <alltraps>
...
80105f6f:	6a 76                	push   $0x76
  jmp alltraps
80105f71:	e9 fa f6 ff ff       	jmp    80105670 <alltraps>
...
80105f78:	6a 77                	push   $0x77
  jmp alltraps
80105f7a:	e9 f1 f6 ff ff       	jmp    80105670 <alltraps>
...
80105f81:	6a 78                	push   $0x78
  jmp alltraps
80105f83:	e9 e8 f6 ff ff       	jmp    80105670 <alltraps>
...
80105f8a:	6a 79                	push   $0x79
  jmp alltraps
80105f8c:	e9 df f6 ff ff       	jmp    80105670 <alltraps>
...
80105f93:	6a 7a                	push   $0x7a
  jmp alltraps
80105f95:	e9 d6 f6 ff ff       	jmp    80105670 <alltraps>
...
80105f9c:	6a 7b                	push   $0x7b
  jmp alltraps
80105f9e:	e9 cd f6 ff ff       	jmp    80105670 <alltraps>
...
80105fa5:	6a 7c                	push   $0x7c
  jmp alltraps
80105fa7:	e9 c4 f6 ff ff       	jmp    80105670 <alltraps>
...
80105fae:	6a 7d                	push   $0x7d
  jmp alltraps
80105fb0:	e9 bb f6 ff ff       	jmp    80105670 <alltraps>
...
80105fb7:	6a 7e                	push   $0x7e
  jmp alltraps
80105fb9:	e9 b2 f6 ff ff       	jmp    80105670 <alltraps>
...
80105fc0:	6a 7f                	push   $0x7f
  jmp alltraps
80105fc2:	e9 a9 f6 ff ff       	jmp    80105670 <alltraps>
...
80105fc9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105fce:	e9 9d f6 ff ff       	jmp    80105670 <alltraps>
...
80105fd5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105fda:	e9 91 f6 ff ff       	jmp    80105670 <alltraps>
...
80105fe1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105fe6:	e9 85 f6 ff ff       	jmp    80105670 <alltraps>
...
80105fed:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105ff2:	e9 79 f6 ff ff       	jmp    80105670 <alltraps>
...
80105ff9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105ffe:	e9 6d f6 ff ff       	jmp    80105670 <alltraps>
...
80106005:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010600a:	e9 61 f6 ff ff       	jmp    80105670 <alltraps>
...
80106011:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106016:	e9 55 f6 ff ff       	jmp    80105670 <alltraps>
...
8010601d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106022:	e9 49 f6 ff ff       	jmp    80105670 <alltraps>
...
80106029:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010602e:	e9 3d f6 ff ff       	jmp    80105670 <alltraps>
...
80106035:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010603a:	e9 31 f6 ff ff       	jmp    80105670 <alltraps>
...
80106041:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106046:	e9 25 f6 ff ff       	jmp    80105670 <alltraps>
...
8010604d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106052:	e9 19 f6 ff ff       	jmp    80105670 <alltraps>
...
80106059:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010605e:	e9 0d f6 ff ff       	jmp    80105670 <alltraps>
...
80106065:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010606a:	e9 01 f6 ff ff       	jmp    80105670 <alltraps>
...
80106071:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106076:	e9 f5 f5 ff ff       	jmp    80105670 <alltraps>
...
8010607d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106082:	e9 e9 f5 ff ff       	jmp    80105670 <alltraps>
...
80106089:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010608e:	e9 dd f5 ff ff       	jmp    80105670 <alltraps>
...
80106095:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010609a:	e9 d1 f5 ff ff       	jmp    80105670 <alltraps>
...
801060a1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060a6:	e9 c5 f5 ff ff       	jmp    80105670 <alltraps>
...
801060ad:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060b2:	e9 b9 f5 ff ff       	jmp    80105670 <alltraps>
...
801060b9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060be:	e9 ad f5 ff ff       	jmp    80105670 <alltraps>
...
801060c5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060ca:	e9 a1 f5 ff ff       	jmp    80105670 <alltraps>
...
801060d1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060d6:	e9 95 f5 ff ff       	jmp    80105670 <alltraps>
...
801060dd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801060e2:	e9 89 f5 ff ff       	jmp    80105670 <alltraps>
...
801060e9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801060ee:	e9 7d f5 ff ff       	jmp    80105670 <alltraps>
...
801060f5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801060fa:	e9 71 f5 ff ff       	jmp    80105670 <alltraps>
...
80106101:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106106:	e9 65 f5 ff ff       	jmp    80105670 <alltraps>
...
8010610d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106112:	e9 59 f5 ff ff       	jmp    80105670 <alltraps>
...
80106119:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010611e:	e9 4d f5 ff ff       	jmp    80105670 <alltraps>
...
80106125:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010612a:	e9 41 f5 ff ff       	jmp    80105670 <alltraps>
...
80106131:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106136:	e9 35 f5 ff ff       	jmp    80105670 <alltraps>
...
8010613d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106142:	e9 29 f5 ff ff       	jmp    80105670 <alltraps>
...
80106149:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010614e:	e9 1d f5 ff ff       	jmp    80105670 <alltraps>
...
80106155:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010615a:	e9 11 f5 ff ff       	jmp    80105670 <alltraps>
...
80106161:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106166:	e9 05 f5 ff ff       	jmp    80105670 <alltraps>
...
8010616d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106172:	e9 f9 f4 ff ff       	jmp    80105670 <alltraps>
...
80106179:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010617e:	e9 ed f4 ff ff       	jmp    80105670 <alltraps>
...
80106185:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010618a:	e9 e1 f4 ff ff       	jmp    80105670 <alltraps>
...
80106191:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106196:	e9 d5 f4 ff ff       	jmp    80105670 <alltraps>
...
8010619d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061a2:	e9 c9 f4 ff ff       	jmp    80105670 <alltraps>
...
801061a9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061ae:	e9 bd f4 ff ff       	jmp    80105670 <alltraps>
...
801061b5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061ba:	e9 b1 f4 ff ff       	jmp    80105670 <alltraps>
...
801061c1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061c6:	e9 a5 f4 ff ff       	jmp    80105670 <alltraps>
...
801061cd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061d2:	e9 99 f4 ff ff       	jmp    80105670 <alltraps>
...
801061d9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061de:	e9 8d f4 ff ff       	jmp    80105670 <alltraps>
...
801061e5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801061ea:	e9 81 f4 ff ff       	jmp    80105670 <alltraps>
...
801061f1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801061f6:	e9 75 f4 ff ff       	jmp    80105670 <alltraps>
...
801061fd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106202:	e9 69 f4 ff ff       	jmp    80105670 <alltraps>
...
80106209:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010620e:	e9 5d f4 ff ff       	jmp    80105670 <alltraps>
...
80106215:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010621a:	e9 51 f4 ff ff       	jmp    80105670 <alltraps>
...
80106221:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106226:	e9 45 f4 ff ff       	jmp    80105670 <alltraps>
...
8010622d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106232:	e9 39 f4 ff ff       	jmp    80105670 <alltraps>
...
80106239:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010623e:	e9 2d f4 ff ff       	jmp    80105670 <alltraps>
...
80106245:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010624a:	e9 21 f4 ff ff       	jmp    80105670 <alltraps>
...
80106251:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106256:	e9 15 f4 ff ff       	jmp    80105670 <alltraps>
...
8010625d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106262:	e9 09 f4 ff ff       	jmp    80105670 <alltraps>
...
80106269:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010626e:	e9 fd f3 ff ff       	jmp    80105670 <alltraps>
...
80106275:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010627a:	e9 f1 f3 ff ff       	jmp    80105670 <alltraps>
...
80106281:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106286:	e9 e5 f3 ff ff       	jmp    80105670 <alltraps>
...
8010628d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106292:	e9 d9 f3 ff ff       	jmp    80105670 <alltraps>
...
80106299:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010629e:	e9 cd f3 ff ff       	jmp    80105670 <alltraps>
...
801062a5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062aa:	e9 c1 f3 ff ff       	jmp    80105670 <alltraps>
...
801062b1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062b6:	e9 b5 f3 ff ff       	jmp    80105670 <alltraps>
...
801062bd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062c2:	e9 a9 f3 ff ff       	jmp    80105670 <alltraps>
...
801062c9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062ce:	e9 9d f3 ff ff       	jmp    80105670 <alltraps>
...
801062d5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062da:	e9 91 f3 ff ff       	jmp    80105670 <alltraps>
...
801062e1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801062e6:	e9 85 f3 ff ff       	jmp    80105670 <alltraps>
...
801062ed:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801062f2:	e9 79 f3 ff ff       	jmp    80105670 <alltraps>
...
801062f9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801062fe:	e9 6d f3 ff ff       	jmp    80105670 <alltraps>
...
80106305:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010630a:	e9 61 f3 ff ff       	jmp    80105670 <alltraps>
...
80106311:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106316:	e9 55 f3 ff ff       	jmp    80105670 <alltraps>
...
8010631d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106322:	e9 49 f3 ff ff       	jmp    80105670 <alltraps>
...
80106329:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010632e:	e9 3d f3 ff ff       	jmp    80105670 <alltraps>
...
80106335:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010633a:	e9 31 f3 ff ff       	jmp    80105670 <alltraps>
...
80106341:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106346:	e9 25 f3 ff ff       	jmp    80105670 <alltraps>
...
8010634d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106352:	e9 19 f3 ff ff       	jmp    80105670 <alltraps>
...
80106359:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010635e:	e9 0d f3 ff ff       	jmp    80105670 <alltraps>
...
80106365:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010636a:	e9 01 f3 ff ff       	jmp    80105670 <alltraps>
...
80106371:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106376:	e9 f5 f2 ff ff       	jmp    80105670 <alltraps>
...
8010637d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106382:	e9 e9 f2 ff ff       	jmp    80105670 <alltraps>
...
80106389:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010638e:	e9 dd f2 ff ff       	jmp    80105670 <alltraps>
...
80106395:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010639a:	e9 d1 f2 ff ff       	jmp    80105670 <alltraps>
...
801063a1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063a6:	e9 c5 f2 ff ff       	jmp    80105670 <alltraps>
...
801063ad:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063b2:	e9 b9 f2 ff ff       	jmp    80105670 <alltraps>
...
801063b9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063be:	e9 ad f2 ff ff       	jmp    80105670 <alltraps>
...
801063c5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063ca:	e9 a1 f2 ff ff       	jmp    80105670 <alltraps>
...
801063d1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063d6:	e9 95 f2 ff ff       	jmp    80105670 <alltraps>
...
801063dd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801063e2:	e9 89 f2 ff ff       	jmp    80105670 <alltraps>
...
801063e9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801063ee:	e9 7d f2 ff ff       	jmp    80105670 <alltraps>
...
801063f5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801063fa:	e9 71 f2 ff ff       	jmp    80105670 <alltraps>
...
80106401:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106406:	e9 65 f2 ff ff       	jmp    80105670 <alltraps>
...
8010640d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106412:	e9 59 f2 ff ff       	jmp    80105670 <alltraps>
...
80106419:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010641e:	e9 4d f2 ff ff       	jmp    80105670 <alltraps>
...
80106425:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010642a:	e9 41 f2 ff ff       	jmp    80105670 <alltraps>
...
80106431:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106436:	e9 35 f2 ff ff       	jmp    80105670 <alltraps>
...
8010643d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106442:	e9 29 f2 ff ff       	jmp    80105670 <alltraps>
...
80106449:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010644e:	e9 1d f2 ff ff       	jmp    80105670 <alltraps>
...
80106455:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010645a:	e9 11 f2 ff ff       	jmp    80105670 <alltraps>
...
80106461:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106466:	e9 05 f2 ff ff       	jmp    80105670 <alltraps>
...
8010646d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106472:	e9 f9 f1 ff ff       	jmp    80105670 <alltraps>
...
80106479:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010647e:	e9 ed f1 ff ff       	jmp    80105670 <alltraps>
...
80106485:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010648a:	e9 e1 f1 ff ff       	jmp    80105670 <alltraps>
...
80106491:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106496:	e9 d5 f1 ff ff       	jmp    80105670 <alltraps>
...
8010649d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801064a2:	e9 c9 f1 ff ff       	jmp    80105670 <alltraps>
...
801064a9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064ae:	e9 bd f1 ff ff       	jmp    80105670 <alltraps>
...
801064b5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064ba:	e9 b1 f1 ff ff       	jmp    80105670 <alltraps>
...
801064c1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064c6:	e9 a5 f1 ff ff       	jmp    80105670 <alltraps>
...
801064cd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064d2:	e9 99 f1 ff ff       	jmp    80105670 <alltraps>
...
801064d9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064de:	e9 8d f1 ff ff       	jmp    80105670 <alltraps>
...
801064e5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801064ea:	e9 81 f1 ff ff       	jmp    80105670 <alltraps>
...
801064f1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801064f6:	e9 75 f1 ff ff       	jmp    80105670 <alltraps>
...
801064fd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106502:	e9 69 f1 ff ff       	jmp    80105670 <alltraps>
...
80106509:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010650e:	e9 5d f1 ff ff       	jmp    80105670 <alltraps>
...
80106515:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010651a:	e9 51 f1 ff ff       	jmp    80105670 <alltraps>
...
80106521:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106526:	e9 45 f1 ff ff       	jmp    80105670 <alltraps>
...
8010652d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106532:	e9 39 f1 ff ff       	jmp    80105670 <alltraps>
...
80106539:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010653e:	e9 2d f1 ff ff       	jmp    80105670 <alltraps>
...
80106545:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010654a:	e9 21 f1 ff ff       	jmp    80105670 <alltraps>
...
80106551:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106556:	e9 15 f1 ff ff       	jmp    80105670 <alltraps>
...
8010655d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106562:	e9 09 f1 ff ff       	jmp    80105670 <alltraps>
...
80106569:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010656e:	e9 fd f0 ff ff       	jmp    80105670 <alltraps>
...
80106575:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010657a:	e9 f1 f0 ff ff       	jmp    80105670 <alltraps>
...
80106581:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106586:	e9 e5 f0 ff ff       	jmp    80105670 <alltraps>
...
8010658d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106592:	e9 d9 f0 ff ff       	jmp    80105670 <alltraps>
...
80106599:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010659e:	e9 cd f0 ff ff       	jmp    80105670 <alltraps>
...
801065a5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065aa:	e9 c1 f0 ff ff       	jmp    80105670 <alltraps>
...
801065b1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065b6:	e9 b5 f0 ff ff       	jmp    80105670 <alltraps>
...
801065bd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065c2:	e9 a9 f0 ff ff       	jmp    80105670 <alltraps>
...
801066cd:	68 cc 77 10 80       	push   $0x801077cc
...
80106810:	a1 a4 55 11 80       	mov    0x801155a4,%eax
{
...
80106854:	0f 84 c2 00 00 00    	je     8010691c <switchuvm+0xec>
  pushcli();
8010685a:	e8 21 da ff ff       	call   80104280 <pushcli>
...
801069a9:	68 11 78 10 80       	push   $0x80107811
...
80106b0d:	68 49 78 10 80       	push   $0x80107849
...
80106b43:	68 61 78 10 80       	push   $0x80107861
...
80106d70:	e8 9b d7 ff ff       	call   80104510 <memmove>
...
80106e9f:	e8 6c d6 ff ff       	call   80104510 <memmove>
    len -= n;
    buf += n;
