...
main(int argc, char *argv[]) {
  ...
  11:	8d 75 84             	lea    -0x7c(%ebp),%esi
    ...
    int rc = fork();
  14:	bb a0 86 01 00       	mov    $0x186a0,%ebx
main(int argc, char *argv[]) {
  19:	81 ec 88 00 00 00    	sub    $0x88,%esp
    int x1 = getreadcount();
  1f:	e8 4e 03 00 00       	call   372 <getreadcount>
  24:	89 85 74 ff ff ff    	mov    %eax,-0x8c(%ebp)
    int rc = fork();
  2a:	e8 9b 02 00 00       	call   2ca <fork>
  ...
  3d:	56                   	push   %esi
  3e:	6a 04                	push   $0x4
  40:	e8 a5 02 00 00       	call   2ea <read>
    for (i = 0; i < 100000; i++) {
  ...
  4f:	7e 21                	jle    72 <main+0x72>
	(void) wait();
  51:	e8 84 02 00 00       	call   2da <wait>
	int x2 = getreadcount();
  56:	e8 17 03 00 00       	call   372 <getreadcount>
	total += (x2 - x1);
  5b:	2b 85 74 ff ff ff    	sub    -0x8c(%ebp),%eax
	printf(1, "XV6_TEST_OUTPUT %d\n", total);
  61:	52                   	push   %edx
  62:	50                   	push   %eax
  63:	68 78 07 00 00       	push   $0x778
  68:	6a 01                	push   $0x1
 ...
 5f1:	a1 44 0a 00 00       	mov    0xa44,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 44 0a 00 00       	mov    %eax,0xa44
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 44 0a 00 00       	mov    %eax,0xa44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 44 0a 00 00    	mov    0xa44,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 44 0a 00 00    	mov    %edx,0xa44
}
 ...
 747:	0a 00 00 
 74a:	c7 05 48 0a 00 00 48 	movl   $0xa48,0xa48
 751:	0a 00 00 
    base.s.size = 0;
 754:	b8 48 0a 00 00       	mov    $0xa48,%eax
 759:	c7 05 4c 0a 00 00 00 	movl   $0x0,0xa4c
 760:	00 00 00 
